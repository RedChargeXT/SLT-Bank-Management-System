...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        r2 = new JRadioButton("F/D Account");
        ...
        r4 = new JRadioButton("R/D Account");
        ...
        c7 = new JCheckBox("I here by declare that above enterted detailed are correct to the best of knowledge.");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if (ae.getSource()==submit){
            ...
            if (r1.isSelected()){
                ...
                accountType = "F/D Account";
            }else if (r3.isSelected()) {
                accountType = "Current Account";
            }else if (r4.isSelected()) {
                accountType = "R/D Account";
            }
