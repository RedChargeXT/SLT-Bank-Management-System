...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno){
        ...
        String incomeCategory[] = {"NILL","<1,50,000","<2,50,000", "<5,00,000", "Upto 10,00,000"};
        ...
        String educationValues[] = {"Non-Graduated","Graduate","Post-Graduate", "Doctrate", "Others"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String saadhaar = aadhar.getText();
        ...
        try{
                ...
                Conn c = new Conn();
                String query = "insert into signuptwo value ('"+formno+"', '"+sreligion+"', '"+scategory+"','"+sincome+"','"+seducation+"','"+soccupation+"','"+span+"','"+saadhaar+"','"+seniorcitizen+"','"+existingaccount+"')";
